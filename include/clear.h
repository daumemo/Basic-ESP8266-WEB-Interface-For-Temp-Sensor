...
<div class="device-card">
    <div class="device-control-extra">
        ...
        <p class="name" style="color:green;">After reboot the Device should connect to a new Wifi. Controls will be available through routers LAN assigned IP address</p>
    </div>
</div>
</body>
</html>
